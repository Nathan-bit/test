...
{path:'', component:LoginComponent},
  ...
  {path:'About',component:AboutComponent,canActivate: [AuthguardGuard,PermissionGuardService]},
  {path:'Contact',component:ContactComponent,canActivate: [AuthguardGuard,PermissionGuardService]},
